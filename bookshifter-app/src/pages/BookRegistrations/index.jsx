              ...
              <div className="flex-1">
                <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                  ...
                  <div className="sm:col-span-4">
                    ...
                    <div className="mt-2">
                      <select
                        onChange={(event) => setFatecId(event.target.value)}
                        id="fatecDestino"
                        name="fatecDestino"
                        autoComplete="fatecDestino"
                        className="p-2 block w-full rounded-md border-0 py-1.8 shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-borderColor w-full sm:text-sm sm:leading-6 bg-bgColor"
                      >
